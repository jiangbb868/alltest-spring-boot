...
public class SasStatisticItem {
    ...
    private String statisticIndicator;

    private String statisticSolution;
    ...
    public void setStatisticObject(String statisticObject) {
        this.statisticObject = statisticObject == null ? null : statisticObject.trim();
    }

    public String getStatisticIndicator() {
        return statisticIndicator;
    }

    public void setStatisticIndicator(String statisticIndicator) {
        this.statisticIndicator = statisticIndicator == null ? null : statisticIndicator.trim();
    }

    public String getStatisticSolution() {
        return statisticSolution;
    }

    public void setStatisticSolution(String statisticSolution) {
        this.statisticSolution = statisticSolution == null ? null : statisticSolution.trim();
    }
