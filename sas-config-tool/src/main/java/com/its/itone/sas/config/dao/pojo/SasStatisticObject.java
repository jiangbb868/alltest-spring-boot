...
public class SasStatisticObject {
    private String id;
    ...
    public String getStatisticObjectType() {
        return statisticObjectType;
    }

    public void setStatisticObjectType(String statisticObjectType) {
        this.statisticObjectType = statisticObjectType == null ? null : statisticObjectType.trim();
    }
