package com.its.itone.sas.config.mybatis.typehandler;

import com.its.itone.sas.config.util.JSONUtils;
...
public abstract class JSONTypeHandler<T> implements TypeHandler<T> {
    ...
    @Override
    public void setParameter(PreparedStatement ps, int i, Object parameter, JdbcType jdbcType) throws
                                                                                               SQLException {
